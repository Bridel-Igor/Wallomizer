...
ColorPickerWindow::ColorPickerWindow(char* sColor, HWND hCaller) :
	...
	btnClr     {{hWnd(), 0x66, 0x00, 0x00,	10,		10,		60,		25},
				...
				{hWnd(), 0xcc, 0x33, 0x33,	205,	10,		60,		25},
				{hWnd(), 0xea, 0x4c, 0x88,	270,	10,		60,		25},
				{hWnd(), 0x99, 0x33, 0x99,	335,	10,		60,		25},

				{hWnd(), 0x66, 0x33, 0x99,	10,		40,		60,		25},
				{hWnd(), 0x33, 0x33, 0x99,	75,		40,		60,		25},
				{hWnd(), 0x00, 0x66, 0xcc,	140,	40,		60,		25},
				{hWnd(), 0x00, 0x99, 0xcc,	205,	40,		60,		25},
				{hWnd(), 0x66, 0xcc, 0xcc,	270,	40,		60,		25},
				{hWnd(), 0x77, 0xcc, 0x33,	335,	40,		60,		25},

				{hWnd(), 0x66, 0x99, 0x00,	10,		70,		60,		25},
				{hWnd(), 0x33, 0x66, 0x00,	75,		70,		60,		25},
				{hWnd(), 0x66, 0x66, 0x00,	140,	70,		60,		25},
				{hWnd(), 0x99, 0x99, 0x00,	205,	70,		60,		25},
				{hWnd(), 0xcc, 0xcc, 0x33,	270,	70,		60,		25},
				{hWnd(), 0xff, 0xff, 0x00,	335,	70,		60,		25},

				{hWnd(), 0xff, 0xcc, 0x33,	10,		100,	60,		25},
				{hWnd(), 0xff, 0x99, 0x00,	75,		100,	60,		25},
				{hWnd(), 0xff, 0x66, 0x00,	140,	100,	60,		25},
				{hWnd(), 0xcc, 0x66, 0x33,	205,	100,	60,		25},
				{hWnd(), 0x99, 0x66, 0x33,	270,	100,	60,		25},
				{hWnd(), 0x66, 0x33, 0x00,	335,	100,	60,		25},

				{hWnd(), 0x00, 0x00, 0x00,	10,		130,	60,		25},
				{hWnd(), 0x99, 0x99, 0x99,	75,		130,	60,		25},
				{hWnd(), 0xcc, 0xcc, 0xcc,	140,	130,	60,		25},
				{hWnd(), 0xff, 0xff, 0xff,	205,	130,	60,		25},
				{hWnd(), 0x42, 0x41, 0x53,	270,	130,	60,		25},
				{hWnd(), 0xff, 0xff, 0xff,	335,	130,	60,		25, true}},
